...
export default function LojasRevendedorasPage() {
    ...
    <>
      <section className="page-head">
        <div className="container">
          <Breadcrumb
            items={[{ label: "Início", href: "/" }, { label: "Lojas Revendedoras" }]}
          />
          <span className="eyebrow">Para lojas e e-commerces</span>
          <h1 style={{ marginTop: 18 }}>
            Tabela de distribuidor com{" "}
            <span style={{ color: "var(--tangerina)" }}>margem saudável</span> para sua loja.
          </h1>
          <p className="lead">
            Atendemos farmácias, lojas de ortopedia, clínicas de fisioterapia e e-commerces
            próprios. Mix recomendado, atendimento próximo e produtos certificados ANVISA/INMETRO
