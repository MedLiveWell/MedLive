...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    desc: "O MED 170R é a versão com rodas do andador compacto MED 170, com estrutura em alumínio, barra central em aço e rodas dianteiras de 5 polegadas que substituem o levantar do andador pelo deslizar suave a cada passo.\nSuporta até 136 kg e tem ajuste de altura por pino click em 8 níveis para adaptação a diferentes estaturas.\nPesa 2,85 kg, é totalmente desmontável e dobrável, com embalagem compacta que facilita o transporte em viagens.",
    specs: ["Desmontável", "Com rodas", "136kg"],
    ...
    differentials: [
      ...
      { iconKey: "cart", title: "Totalmente desmontável", desc: "Estrutura que se separa em partes para transporte em viagens e armazenamento em pouco espaço." },
      { iconKey: "check", title: "Ajuste de altura em 8 níveis", desc: "Sistema de pino click que adapta o andador ao usuário sem ferramentas." },
    ],
    dimensions: [
      ["Largura", "48 cm"],
  ...
  },
  {
    ...
    desc: "Com encosto e assento amplo de 50 cm, a MED 380 oferece mais espaço e apoio dorsal para quem precisa de estabilidade e conforto durante o banho.\n\nLeve, resistente à corrosão e com ponteiras antiderrapantes de borracha, se adapta bem a ambientes domiciliares, clínicos e institucionais.\n\nAltura regulável em 6 níveis por pino click, sem ferramentas.",
  ...
  },
  {
    ...
    imageTransforms: ["scaleX(-1)"],
    differentials: [
      { iconKey: "users", title: "Apoio de braços", desc: "Barras laterais em alumínio para suporte seguro ao sentar e ao levantar." },
      { iconKey: "shield", title: "Estrutura mais larga", desc: "53 cm de largura total para maior estabilidade e conforto durante o banho." },
      { iconKey: "check", title: "Assento com escoamento", desc: "Furos no assento em HDPE evitam acúmulo de água e reduzem risco de escorregões." },
    ],
    dimensions: [
      ["Largura", "53 cm"],
      ["Altura", "70,5 – 80,5 cm"],
  ...
  // Cadeiras de banho (3)
  {
    ...
    desc: "Cadeira de banho em aço com pintura eletrostática e encosto revestido em poliuretano, a MED 410 oferece conforto e apoio completo para banho assistido com segurança.\n\nCom rodas com freio, apoio de pés rebatível e suporte para comadre, atende ambientes domiciliares, clínicos e institucionais.",
    specs: ["Aço", "Desmontável", "150kg"],
    image: med410Images[0],
    images: med410Images,
    vendemosHighlight: true,
    differentials: [
      { iconKey: "shield", title: "Encosto revestido", desc: "Poliuretano macio sobre estrutura em aço para conforto e apoio dorsal durante o banho." },
      { iconKey: "arrow", title: "Rodas com freio", desc: "Rodas em polipropileno e aço com trava para deslocamento seguro e posicionamento estável." },
      { iconKey: "homecare", title: "Suporte para comadre", desc: "Estrutura multifuncional com apoio de pés rebatível e encaixe para comadre integrado." },
    ],
    dimensions: [
      ["Largura", "45 cm"],
      ["Altura", "93 cm"],
